...
const HomeMiddle = () => {
    ...
    return (
        ...
        {width <650 ?
            ...
            marginLeft:'100px'
            }}> Réduire l'impact <br/> un <em className='highlight'>vecteur</em> de croissance</h2>
            </div>
            ...
            <p style={{fontSize:'3em', color:'#54565a',
            }}>{collab}</p>
            <h5 style={{fontSize:'1em'}}>COLLABORATEURS  </h5>
            <p style={{fontSize:'3em', color:'#54565a',
            }}>{kw.toFixed(1)}TWh</p>
            <h5 style={{fontSize:'1em'}}>ÉCONOMIES GÉNÉRÉES EN 2019</h5>
            <p style={{fontSize:'3em', color:'#54565a',
                        }}>+{ca}M€</p>
        ...
        <div style={{height:'100vh'}} >
            ...
            <Link to='/groupe'><button className='btn-lg btn-info'>Découvrir le groupe</button></Link>
            </div>
