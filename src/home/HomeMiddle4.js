...
const HomeMiddle4 = () => {
    ...
    return (
        ...
        {width < 650 ?
            ...
            <div className='home-pic4'  style={{marginTop: '30px', backgroundSize:'100%', height:'300px' ,backgroundRepeat:'no-repeat',
            ...
            style={{
                zIndex:'1000',
                marginTop: '30px', backgroundSize:'100%', 
            ...
            <div className='d-flex jus justify-content-lg-between'>
             <Link  to='/medias'>
             <button style={{marginTop:'80px', marginLeft:'60px'}}
              className='btn btn-info'>Tous nos articles</button></Link> 
             <Link  to='/presse'>
             <button style={{marginTop:'80px', marginLeft:'50px'}} 
             className='btn btn-info'>Espace presse</button></Link> 
